...
3. Deep Learning Book: [Link](https://www.deeplearningbook.org/) 
4. Dive into Deep Learning (D2L): [Link](https://d2l.ai/)
5. DeepLearning.ai: [Link](https://www.coursera.org/partners/deeplearning-ai)
6. Neural Network: From Zero to Hero: [Link](https://karpathy.ai/zero-to-hero.html) 
7. Chaofa’s Blog: [Link](https://bruceyuan.com/)
8. Chaofa’s LLMs-Zero-to-Hero: [Link](https://github.com/bbruceyuan/LLMs-Zero-to-Hero)
